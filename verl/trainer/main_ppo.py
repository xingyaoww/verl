...
import torch
from verl.utils.reward_score import gsm8k, math, generative_orm
from verl.trainer.ppo.ray_trainer import RayPPOTrainer, RayPRIMETrainer
...
def _select_rm_score_fn(data_source):
    ...
    elif data_source == 'generative_orm':
        return generative_orm.compute_score
    else:
